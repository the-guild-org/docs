...
export const HeroGradient = ({
  ...
  return (
    <section className={clsx('bg-white dark:bg-dark md:py-14', className)}>
      <div
        className={clsx(
      ...
      >
        <div
          className="absolute inset-0 z-[-1] overflow-hidden bg-black dark:bg-dark md:mx-6 md:rounded-3xl"
