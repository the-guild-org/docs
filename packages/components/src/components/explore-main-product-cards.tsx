...
export function ExploreMainProductCards({ className, ...rest }: ExploreMainProductCardsProps) {
  return (
    ...
    >
      ...
      <ul className="-mx-12 -my-2 flex shrink-0 grow flex-row gap-[22px] overflow-auto px-12 py-2 [@media(max-width:1490px)]:w-full [@media(min-width:1490px)]:overflow-visible [&>:nth-child(n+4)]:[@media(min-width:1490px)]:hidden">
