...
export function HiveFooter({ className, logo, resources, sameSite }: IFooterExtendedProps) {
  return (
    <footer className={clsx('dark:bg-green-1000 bg-white px-4 py-6 text-base', className)}>
