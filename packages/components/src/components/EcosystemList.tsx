...
export const EcosystemList = (): ReactElement => {
  return (
    <div
      className="max-h-[calc(100vh-70px)] min-h-[300px] w-[800px] overflow-y-auto rounded-md bg-white p-5 dark:bg-gray-800"
      style={{
            ...
            {category.items.map(product => (
              ...
              >
                ...
                <span className="flex flex-col justify-center">
                  ...
                  <p className="m-0 text-xs font-medium text-gray-900 dark:text-gray-400">{product.title}</p>
                </span>
              </a>
            ))}
          </div>
